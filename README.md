...
​		现在就在你的Kindle浏览器中打开Kindle实用工具网站主页  [https://wellpeng.gitee.io](https://wellpeng.gitee.io/) 吧！
...
|     图片+时钟      |    `/pic`    |    `/pic`    |    `/pic`    |    ✕     |                              √                               |
|    一言 + 时钟     |   `/yiyan`   | `/yiyanDark` | `/yiyanAuto` |    √     | √（由于gitee审核政策该功能无法使用，欲体验请跳转GitHub项目） |
|        ...         |     ...      |     ...      |     ...      |   ...    |                             ...                              |
...
6. gitee为国内镜像版本，欢迎大家访问本项目的GitHub页面https://github.com/1pone/1pone.github.io
